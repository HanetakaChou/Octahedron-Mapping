...
GLSL_COMPILER_PATH := $(LOCAL_PATH)/../thirdparty/shaderc/bin/glslc.exe
...
all : $(SPIRV_DIR)/point_light_shadow_vertex.inl $(SPIRV_DIR)/point_light_shadow_fragment.inl $(SPIRV_DIR)/forward_shading_vertex.inl $(SPIRV_DIR)/forward_shading_fragment.inl

$(SPIRV_DIR)/point_light_shadow_vertex.inl $(SPIRV_DIR)/point_light_shadow_vertex.d : $(SHADERS_DIR)/point_light_shadow_vertex.sl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es -mfmt=num -fshader-stage=vert $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/point_light_shadow_vertex.d" -o "$(SPIRV_DIR)/point_light_shadow_vertex.inl" "$(SHADERS_DIR)/point_light_shadow_vertex.sl"

$(SPIRV_DIR)/point_light_shadow_fragment.inl $(SPIRV_DIR)/point_light_shadow_fragment.d : $(SHADERS_DIR)/point_light_shadow_fragment.sl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es -mfmt=num -fshader-stage=frag $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/point_light_shadow_fragment.d" -o "$(SPIRV_DIR)/point_light_shadow_fragment.inl" "$(SHADERS_DIR)/point_light_shadow_fragment.sl"
...
-include $(SPIRV_DIR)/point_light_shadow_vertex.d $(SPIRV_DIR)/point_light_shadow_fragment.d $(SPIRV_DIR)/forward_shading_vertex.d $(SPIRV_DIR)/forward_shading_fragment.d
